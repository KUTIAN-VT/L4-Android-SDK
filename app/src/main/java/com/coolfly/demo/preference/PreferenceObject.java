...
public class PreferenceObject implements Serializable {
    ...
    public Integer p401_1vn_tx_buffer_port1 = 2000;
    ...
    public VPN_PROVIDER p401_vpn_provider = VPN_PROVIDER.ROOT;
    ...
    public Boolean show_udp_log = UdpController.isShowLog;
